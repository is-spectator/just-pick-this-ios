...
> 2026-06 产品化更新：早期“三 Tab”壳已经被 Chat-first App Shell 取代。App 启动后直接进入皮皮聊天；来一句、我的求一个、我的回答、收藏、奖励和账号入口统一收进左侧 Drawer。

## 新增

- 单一 Chat 主界面：顶部菜单 / 皮皮 / 新对话，底部 Composer。
- 左侧 Drawer：搜索、新对话、来一句、我的求一个、我的回答、收藏、奖励、置顶、最近和账号入口。
- Drawer 产品页：我的求一个、我的回答、收藏、奖励已拆成独立页面，不再统一塞进“我的”页。
